...
def engrave_hatch(inImage, inLayer) :
    # First say hello
    ...
    pdb.gimp_message("tryting to string stuff")
    i = 4
    pattstring = "Eng109A"
    ...
    pdb.gimp_context_set_pattern ("Eng109A6")
    pdb.gimp_image_select_color (inImage, CHANNEL_OP_REPLACE, parentlayer, acolour)
    #pdb.gimp_edit_fill(parentlayer, FOREGROUND_FILL)
    ...
    pdb.gimp_context_set_sample_criterion (SELECT_CRITERION_COMPOSITE)
    pdb.gimp_context_set_sample_threshold(0.05)
    pdb.gimp_context_set_pattern ("Eng109A5a")
    pdb.gimp_image_select_color (inImage, CHANNEL_OP_REPLACE, parentlayer, gcolour)
    #pdb.gimp_edit_fill(parentlayer, FOREGROUND_FILL)
    pdb.gimp_edit_bucket_fill (parentlayer, PATTERN_BUCKET_FILL, NORMAL_MODE, 100.0, 0.05, False, 10.0, 15.0)
    pdb.gimp_selection_none( inImage )
    ...
    # pdb.gimp_context_set_pattern ("Engrave 106 multi A")
    pdb.gimp_context_set_pattern ("Eng109A4")
    pdb.gimp_image_select_color (inImage, CHANNEL_OP_REPLACE, parentlayer, fcolor)
    pdb.gimp_edit_bucket_fill (parentlayer, PATTERN_BUCKET_FILL, NORMAL_MODE, 100.0, 0.05, False, 10.0, 15.0)
    pdb.gimp_selection_none( inImage )
    ...
    fcolor = ((calccolourval, calccolourval, calccolourval))
    #fcolor = ((colourvalue*3,colourvalue*3,colourvalue*3))
    # pdb.gimp_context_set_pattern ("Engrave 106 multi A")
    pdb.gimp_context_set_pattern ("Eng109A3")
    pdb.gimp_image_select_color (inImage, CHANNEL_OP_REPLACE, parentlayer, fcolor)
    pdb.gimp_edit_bucket_fill (parentlayer, PATTERN_BUCKET_FILL, NORMAL_MODE, 100.0, 0.05, False, 10.0, 15.0)
    pdb.gimp_selection_none( inImage )
    ...
    pdb.gimp_context_set_pattern ("Eng109A2")
    ...
    dcolor = ((calccolourval, calccolourval, calccolourval))
    # pdb.gimp_context_set_pattern ("KHEngrave2")
    pdb.gimp_context_set_pattern ("Eng109A1")
    pdb.gimp_image_select_color (inImage, CHANNEL_OP_REPLACE, parentlayer, dcolor)
    pdb.gimp_edit_bucket_fill (parentlayer, PATTERN_BUCKET_FILL, NORMAL_MODE, 100.0, 0.05, False, 10.0, 15.0)
    pdb.gimp_selection_none( inImage )
    ...
    dcolor = ((calccolourval, calccolourval, calccolourval))
    # pdb.gimp_context_set_pattern ("KHEngrave2")
    pdb.gimp_context_set_pattern ("Eng109A0")
    pdb.gimp_image_select_color (inImage, CHANNEL_OP_REPLACE, parentlayer, dcolor)
    pdb.gimp_edit_bucket_fill (parentlayer, PATTERN_BUCKET_FILL, NORMAL_MODE, 100.0, 0.05, False, 10.0, 15.0)
    pdb.gimp_selection_none( inImage )
    ...
    ecolor = ((255,255,255))
    # pdb.gimp_context_set_pattern ("Engrave 007 A")
    pdb.gimp_context_set_pattern ("Eng109A0")
