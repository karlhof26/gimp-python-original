...
## VERSION HISTORY
## Version 2.17 release date 24-Oct-2020
## Ready for Gimp-2.10.22
## KarlHof26 (za) and (uk)
##
...
mainname="Contact sheet py "+whoiam

register(
        "python_fu_contact_sheet_V216",
        "Generates a contact sheet(s) for a directory of images. If you find this script useful or any bugs I would love to hear from you robin.gilham@gmail.com\nHeck you could even consider a donation."+whoiam,
        "Generates contact sheet(s) with a configurable number of thumbnails for all files located in a directory",
        "Robin Gilham, E. Sullock Enzlin, K Hofmeyr",
        "Licensed under the GPL v2",
        "2008, 2009, 2010, 2011, 2015, 2020",
        "Contact Sheet V2.17",
        "",
        [
            (PF_OPTION, "file_type"  ,"File type: ", 0 ,[".jpg", ".png", ".tif", ".pcx",
                                                        ".xcf",".eps",".bmp", "all registered formats"]),
            # (PF_FILENAME, "file_name", "File name: ", 0),
            (PF_DIRNAME, "location", "Generate contact sheet of all files in this directory: ", os.getcwd() ),
            (PF_BOOL, "all_subdirs", "Include all subdirs? ", False),        
            (PF_BOOL, "inc_filename", "Include filename on contact sheet?", True),
            (PF_BOOL, "inc_extension", "Filename with extension?", True),
            ...
            (PF_DIRNAME, "contact_location", "Where the contact sheet should be saved in: ", os.getcwd() ),
            (PF_OPTION, "contact_size", "Contact page sheet size: ", 3,
                 ["Jumbo (10.2x15.2 cm)",
                  "6x8 (15.2x20.3 cm)",
                  "8x10 (20.3x25.4 cm)",
                  "A4 (20.9x29.7 cm)",
