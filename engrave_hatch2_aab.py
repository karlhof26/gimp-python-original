...
def engrave_hatch2(inImage, inLayer) :
    # First say hello
    ...
    engravelayer.mode = LAYER_MODE_NORMAL
    ...
    pdb.gimp_selection_none( inImage )
    pdb.gimp_drawable_desaturate ( engravelayer, DESATURATE_LIGHTNESS )
    ...
    pdb.gimp_context_set_sample_criterion (SELECT_CRITERION_COMPOSITE)
    pdb.gimp_context_set_sample_threshold(0.075)
    pdb.gimp_context_set_pattern ("Engrave 102 D")
    pdb.gimp_image_select_color (inImage, CHANNEL_OP_REPLACE, engravelayer, gcolour)
    # dont use pdb.gimp_edit_fill(parentlayer, FOREGROUND_FILL)
    pdb.gimp_edit_bucket_fill (parentlayer, BUCKET_FILL_PATTERN, LAYER_MODE_NORMAL, 100.0, 0.05, False, 10.0, 15.0)
    pdb.gimp_selection_none( inImage )
    ...
    pdb.gimp_context_set_pattern ("Engrave 102 A")
    ...
    # dont use pdb.gimp_context_set_pattern ("Engrave 106 multi A")
    pdb.gimp_context_set_pattern ("Engrave 102 B")
    pdb.gimp_image_select_color (inImage, CHANNEL_OP_REPLACE, engravelayer, fcolor)
    pdb.gimp_edit_bucket_fill (parentlayer, BUCKET_FILL_PATTERN, LAYER_MODE_NORMAL, 100.0, 0.05, False, 10.0, 15.0)
    pdb.gimp_selection_none( inImage )
    ...
    pdb.gimp_context_set_pattern ("Engrave 102 G")
    ...
    dcolor = ((calccolourval, calccolourval, calccolourval))
    # dont use pdb.gimp_context_set_pattern ("KHEngrave2")
    pdb.gimp_context_set_pattern ("Engrave 102 E")
    pdb.gimp_image_select_color (inImage, CHANNEL_OP_REPLACE, engravelayer, dcolor)
    pdb.gimp_edit_bucket_fill (parentlayer, BUCKET_FILL_PATTERN, LAYER_MODE_NORMAL, 100.0, 0.05, False, 10.0, 15.0)
    pdb.gimp_selection_none( inImage )
    ...
    dcolor = ((calccolourval, calccolourval, calccolourval))
    # dont use pdb.gimp_context_set_pattern ("KHEngrave2")
    pdb.gimp_context_set_pattern ("Engrave 102 H")
    pdb.gimp_image_select_color (inImage, CHANNEL_OP_REPLACE, engravelayer, dcolor)
    pdb.gimp_edit_bucket_fill (parentlayer, BUCKET_FILL_PATTERN, LAYER_MODE_NORMAL, 100.0, 0.05, False, 10.0, 15.0)
    pdb.gimp_selection_none( inImage )
    ...
    ecolor = ((255,255,255))
    pdb.gimp_message ("colour black")
    # dont use pdb.gimp_context_set_pattern ("Engrave 007 A")
    pdb.gimp_context_set_pattern ("Engrave 102 I")
    pdb.gimp_context_set_sample_criterion (SELECT_CRITERION_COMPOSITE)
    pdb.gimp_context_set_sample_threshold(0.075)
...
register(
    ...
    "Karl Hofmeyr",
    "2015",
    "Engrave using hatching wood shades",
    "*",
    [
    ...
    [],
    engrave_hatch2,
    menu="<Image>/Python-Fu/Render/Engraving/")
